...
const serve = require('vitaminjs-build/bin/serve');
const listenExitSignal = require('vitaminjs-build/bin/listenExitSignal');

require('vitaminjs-build/bin/setVitaminPath');
